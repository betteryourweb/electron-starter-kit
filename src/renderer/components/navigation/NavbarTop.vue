  ...
  <div class="NavbarTop">
    <div class="Top">
      ...
      <div class="menuItems">
        ...
        <a href="#" class="windowControl" @click.prevent="maximize" v-if="!isMaximized && !isFullscreen">
          <i class="fa fa-window-maximize"></i>
        </a>
        <a href="#" class="windowControl" @click.prevent="restore" v-if="isMaximized && !isFullscreen">
